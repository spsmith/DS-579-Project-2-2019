    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float4 _Property_ADAAD273_Out_0 = _BaseColor;
                float _Property_5B4F6A97_Out_0 = _Metallic;
                float _Property_97B94FE5_Out_0 = _Specular;
                surface.Albedo = (_Property_ADAAD273_Out_0.xyz);
                surface.Normal = IN.TangentSpaceNormal;
                surface.Emission = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
                surface.Metallic = _Property_5B4F6A97_Out_0;
                surface.Smoothness = _Property_97B94FE5_Out_0;
                surface.Occlusion = 1;
                surface.Alpha = 1;
